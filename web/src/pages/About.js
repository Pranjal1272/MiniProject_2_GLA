      ...
      <div className="container">
        <section className="about-section">
          ...
          <div className="about-image">
            <img src="https://via.placeholder.com/500x300?text=Our+Story" alt="Petshielders volunteers with pets" />
          </div>
        </section>
        ...
        <section className="team-section">
          ...
          <div className="team-grid">
            <div className="team-member">
              <img src="https://via.placeholder.com/200x200?text=Jane+Doe" alt="Pranjal Prajapati" className="team-photo" />
            ...
            <div className="team-member">
              <img src="https://via.placeholder.com/200x200?text=John+Smith" alt="Racheet Saraswat" className="team-photo" />
            ...
            <div className="team-member">
              ...
              <p className="team-bio">
                Shivam works directly with potential adopters to help them find their perfect pet match and ensure
            ...
            <div className="team-member">
              ...
              <p className="team-bio">
                Shivani provides medical care for all the animals in our shelter and ensures they're healthy before
                adoption.
              </p>
            </div>
          </div>
